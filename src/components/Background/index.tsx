...
export default function CanvasBack({ row = 12, col = 8 }: { row?: number; col?: number; }) {
  const myCanvas = useRef<HTMLCanvasElement>(null);
  const data = useRef<{ ctx: any; dots: Array<any>; width: number; height: number }>(
    {
      ctx: null,
      dots: [],
      width: 0,
